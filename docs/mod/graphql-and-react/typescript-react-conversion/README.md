...
This walk-through illustrates how to adopt TypeScript in an existing React/Babel/Webpack project. We'll start with a TicTacToe project written fully in JavaScript in the `TicTacToe_JS` folder as an example. By the end, you will have a TicTacToe project fully written with TypeScript.
...
<p align="center">
    <img src ="https://raw.githubusercontent.com/microsoft/TypeScript-React-Conversion-Guide/master/image/components.png"/>
</p>
